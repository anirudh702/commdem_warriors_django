...
class WorkoutWiseChallengesModel(models.Model):
    ...
    challenge_name = models.CharField(max_length=80,default='',unique=True,db_index=True)
    challenge_video_url = models.CharField(max_length=80,unique=True,db_index=True,default='')
