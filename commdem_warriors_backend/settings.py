...
# translated_text = translator.translate('Hi tanu, please listen to me I know yesterday was tough day for you, but I just want you to ask yourself that do I really dont have 20 min to do exercise ?',dest='bn')  # noqa: E501
# tts = gtts.gTTS('hello sir, can I show you flow of features in our application ?',lang = 'en',slow=False,tld='co.in')  # noqa: E501
...
ASGI_APPLICATION = (
    "commdem_warriors_backend.routing.application"  # routing.py will be created later
)
CHANNEL_LAYERS = {"default": {"BACKEND": "channels.layers.InMemoryChannelLayer"}}

# REST_FRAMEWORK = {
#     'DEFAULT_AUTHENTICATION_CLASSES': [
#         'commdem_warriors_backend.authenticators.ApiKeyAuthentication',
#     ],
#     # ...
# }
