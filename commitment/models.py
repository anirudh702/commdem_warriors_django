...
class CommitmentNameModel(models.Model):
    ...
    name = models.CharField(max_length=200,null=False,unique=True)
    successName = models.CharField(max_length=200,null=False,unique=True)
    failureName = models.CharField(max_length=200,null=False,unique=True)
    currentDayName = models.CharField(max_length=200,null=False,unique=True)
    created_at = models.DateTimeField(default=django.utils.timezone.now, blank=True)
    updated_at = models.DateTimeField(default=django.utils.timezone.now, blank=True)
    objects = models.Manager()
