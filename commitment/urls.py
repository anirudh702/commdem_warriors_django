...
urlpatterns = [
    ...
    path('add_no_of_commitments_user_will_do_next_week/', views.add_no_of_commitments_user_will_do_next_week, name="add_no_of_commitments_user_will_do_next_week"),
    ...
    path('get_no_of_commitments_user_will_do_current_week/', views.get_no_of_commitments_user_will_do_current_week, name="get_no_of_commitments_user_will_do_current_week"),
    path('get_number_of_all_commitments_of_user_of_the_week/', views.get_number_of_all_commitments_of_user_of_the_week, name="get_number_of_all_commitments_of_user_of_the_week"),
