# Generated by Django 4.1.2 on 2022-12-04 07:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=200, unique=True,db_index=True)),
                ('successName', models.CharField(max_length=200, unique=True,db_index=True)),
                ('failureName', models.CharField(max_length=200, unique=True,db_index=True)),
                ('currentDayName', models.CharField(max_length=200, unique=True,db_index=True)),
                ('created_at', models.DateTimeField(blank=True, default=django.utils.timezone.now)),
                ('updated_at', models.DateTimeField(blank=True, default=django.utils.timezone.now)),
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='commitment.commitmentcategorymodel')),
            ],
