...
from voiceAssistant.models import voiceAssistantBeforeUpdateMessageModel,voiceAssistantAfterUpdateMessageModel
...
class VoiceAssistantAfterUpdateMessageModelAdmin(admin.ModelAdmin):
    list_filter = (
        ('commitment_category', admin.RelatedOnlyFieldListFilter),
    )
    pass