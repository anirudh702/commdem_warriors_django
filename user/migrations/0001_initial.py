    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile_number', phonenumber_field.modelfields.PhoneNumberField(db_index=True, error_messages={'unique': 'This mobile number already exists in our database'}, max_length=128, region=None, unique=True)),
                ('email', models.EmailField(blank=True, db_index=True, error_messages={'unique': 'This Email already exists in our database'}, max_length=254, null=True, unique=True)),
